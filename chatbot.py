...
async def main(client: Client):
    async def send() -> None:
        ...
        messages.append(('Your Agent Bruce', response))
        thinking = False
        chat_messages.refresh()
    ...
    with ui.footer().classes('bg-white'), ui.column().classes('w-full max-w-3xl mx-auto my-6'):
        ...
        ui.markdown('Source code at Repo:[AIAgentHackathon](https://github.com/bsyh/AIAgentHackathon)') \
            .classes('text-xs self-end mr-8 m-[-1em] text-primary')

ui.run(title='Chat with GPT-3.5')